export default function BootstrapsGrids() {
    return (
        <>
        <h2>Bootstrap</h2>
...
<div id="wd-bs-responsive-grids-2">
            ...
            <div className="col-12 col-md-6 bg-warning">
                ...
                <div className="col-12 col-md-6 bg-primary text-white">
                    <h3>Column B</h3>
                </div>
                <div className="col-12 col-md-6 bg-danger text-white">
                    <h3>Column C</h3>
                </div>
                <div className="col-12 col-md-6 bg-success text-white">
                    <h3>Column D</h3>
                </div>
            </div>
        </div>
        <div id="wd-bs-responsive-grids-3">
