    ...
    return (
      <div id="wd-lab1">
        ...
        <div id="wd-h-tag">
          ...
          <div id="wd-lists">
            ...
            <ol id="wd-your-favorite-recipe">
              <li>Mix dried blueberry in pancake mix.</li> 
              <li>Add extra butter.</li> 
              <li>Add fresh fruit before serving.</li> 
            </ol> 
        ...
        <div id="wd-images">
          ...
          <br />
          <img id="IMG_2642" src="/Users/sy/Downloads/IMG_2642.JPG" height="500px" />
        </div>
        ...
        <div id="wd-forms">
          ...
          <input id="wd-text-fields-username" type="text" placeholder="sy" />
          <br />
          <label htmlFor="wd-text-fields-password">Password:</label>
          <input type="password" id="wd-text-fields-password" value="ssssssyy56" />
          <br />
          <label htmlFor="wd-text-fields-first-name">First name:</label>
          <input type="text" id="wd-text-fields-first-name" title="Sammy" /> <br />
          ...
          <input type="date" id="wd-text-fields-dob" defaultValue="2000-01-01" />
          <br />
        </div>
        <h4>Anchor tag</h4>
        Please
